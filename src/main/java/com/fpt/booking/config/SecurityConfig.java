    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorizationManagerRequestMatcherRegistry ->
                        authorizationManagerRequestMatcherRegistry.requestMatchers(HttpMethod.DELETE).hasAnyRole("ADMIN","MECHANIC","USER")
                                .requestMatchers("/api/admin/**").hasAnyRole("ADMIN","USER","MECHANIC")
                                .requestMatchers("/api/user/**").hasAnyRole("USER", "MECHANIC", "ADMIN")
                                .requestMatchers("/api/mechanic/**").hasAnyRole("MECHANIC", "ADMIN")
                                .requestMatchers("/api/auth/**","/api/mechanic/**","/api/user/**","/api/files/**",
                                        "/api/reset-password/**","/api/forgot-password/**",
                                        "/api/verify-otp/**","/api/sendOtp/**","/api//validateOtp/**").permitAll()
